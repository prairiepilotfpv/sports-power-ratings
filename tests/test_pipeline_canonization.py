...
from pipelines.schedule import MODEL_METADATA_DATA_START_ROW, build_schedule_excel_report
...
class TestPipelineCanonization:
    ...
    def test_full_pipeline_flow_nba(self, tmp_path: Path) -> None:
        ...
        future_games = schedule_df[schedule_df["status"] == "scheduled"]
    ...
    def test_market_parameter_isolation(self, tmp_path: Path) -> None:
        ...
        save_model_market_tuning_run(
            ...
            run_id="test_ml",
            best_score=0.5,
            best_params_json=json.dumps(ml_params, sort_keys=True),
        ...
        save_model_market_tuning_run(
            ...
            run_id="test_spread",
            best_score=5.0,
            best_params_json=json.dumps(spread_params, sort_keys=True),
            summary_metrics_json=None,
            started_at=None,
            finished_at=None,
            notes=None,
